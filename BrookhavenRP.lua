local LoadingScreen =loadstring(game:HttpGet("https://pastefy.app/wmC1DHTs/raw?part=addon.lua"))()

-- â€¦ Script de ativaÃ§Ã£o automÃ¡tica de eventos (Hub)
...
-- FunÃ§Ã£o para disparar eventos com seguranÃ§a 
local function fireEvent(event, ...)
    if event then
        event:FireServer(...)
    else
        warn("Evento nÃ£o encontrado:", event)
    end
end

-- Nome de RolePlay
fireEvent(NameTextEvent, "RolePlayName", "usuÃ¡rio tubers hub")

-- Cor do Nome (preto)
fireEvent(NameColorEvent, "PickingRPNameColor", Color3.new(255, 90, 90))

-- Bio de RolePlay
fireEvent(NameTextEvent, "RolePlayBio", "tubers hub versÃ£o natalðŸŽ…")

-- Cor da Bio (vermelho)
fireEvent(NameColorEvent, "PickingRPBioColor", Color3.new(255, 0, 0))

task.wait(7.1)
local redzlib =loadstring(game:HttpGet("https://pastefy.app/DZ5ihdHh/raw?part=addon.lua"))()


local Window = redzlib:MakeWindow({
    Title = "tubers hub           Brookhaven RP",
...
local MinimizeBtn = Window:AddMinimizeButton({
    Button = { 
        Image = "rbxassetid://85184918166828", 
...
Tab1:AddDiscordInvite({
    Name = " tubers comunitty ",
    Description = "servidor off pÃ³s foi raidado",
    Logo = "rbxassetid://85184918166828",
    Invite = "https://discord.gg/eH2zEtdh9",
})
...
local Section = Tab1:AddSection({"versao do Hub 5.0 "})

local Paragraph = Tab1:AddParagraph({"Criadores", "silvadev."})

local Paragraph = Tab1:AddParagraph({"Parceiros", " auralynx hub"})

  Tab1:AddButton({
    Name = "â€¢ Copiar nosso Youtube",
    Description = "Copia o link junto com o @",
    Callback = function()
      setclipboard("@") -- Copia o @
      setclipboard("https://youtube.com/@gabriellsilvaa7?si=e9AZWgER65ogBJU0") -- Copia o link
...
Tab2:AddSlider({
 ...
 local Section = Tab2:AddSection({"FunÃ§Ãµes normais"})
        ...
        local args = {
            {
                ...
                129643681805465,  -- BraÃ§o Direito
                121845409370294,  -- BraÃ§o Esquerdo
                124374125166137, -- Torso
                133717899283546   -- CabeÃ§a
            }
        }
        ...
        local args = {
            {
                ...
                131681603005543,  -- BraÃ§o Direito
                107032747230578,  -- BraÃ§o Esquerdo
                129341990941517, -- Torso
                109137349673343   -- CabeÃ§a
            }
        }
        game:GetService("ReplicatedStorage")
            :WaitForChild("Remotes")
...
local Section = Tab13:AddSection({"FunÃ§Ãµes RGB"})
...
local Section = Tab13:AddSection({"RGB para usar em vocÃª"})
...
local Section = Tab7:AddSection({"Loop Ã¡udio estourado"})
...
Tab9:AddToggle({
    ...
    Callback = function(state)
        ...
        if state then
            ...
            -- Loop contÃ­nuo enquanto o toggle estiver ativo
            task.spawn(function()
...
local kill = Tab9:AddSection({Name = "Click MÃ©todos (vocÃªs pediram)"})
...
---------------------------------------------------------------------------------------------------------------------------------
                                                   -- === Tab 10: attack server === --
---------------------------------------------------------------------------------------------------------------------------------

-- BotÃ£o para Giant Joust Red N4zi
Tab10:AddButton({
    ...
    Callback = function()
        ...
        for i, tool in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
            if tool:IsA("Tool") then
                -- Przeniesienie narzÃ„â„¢dzia do postaci gracza
                ...
                -- Ustawienie pozycji chwytu (GripPos), jeÃ…â€ºli narzÃ„â„¢dzie jest w postaci gracza
...
Tab10:AddParagraph({
    "InformaÃ§Ã£o de Lag",
    "O efeito de lag comeÃ§a apos 35 segundos"
})
...
Tab10:AddParagraph({
    "InformaÃ§Ã£o de Lag",
    "O script comeÃ§a a causar lag apos 35 segundos"
})

Tab10:AddSection({ "(OP) Tornado" })
...
local Section = Tab10:AddSection({"ExpansÃ£o de domÃ­nio"})

Tab10:AddButton({
    Name = " ExpansÃ£o de domÃ­nioðŸŒŒ",
    Callback = function()
        -- ServiÃ§os
        local TextChatService = game:GetService("TextChatService")
        ...
        _G.AtaqueArmaAtivo = true

        -- Aviso no chat (com \r conforme seu pedido)
        if TextChatService.ChatVersion == Enum.ChatVersion.TextChatService then 
            TextChatService.TextChannels.RBXGeneral:SendAsync(
                "Hi\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r ExpansÃ£o de DomÃ­nio ativada"
            )
        else 
            print("Ataque funcionando kkkkk")
        end

        -- FunÃ§Ã£o para ativar ExpansÃ£o de DomÃ­nio
        ...
        -- Executa a expansÃ£o de domÃ­nio
        ativarDominio()

        -- Ãudio em loop infinito no jogador
        ...
        -- Loop automÃ¡tico de ataque
        task.spawn(function()
            while _G.AtaqueArmaAtivo do
                clearAllTools()
                getAssault()

                repeat
                    task.wait(0.2)
                until hasAssault() or not _G.AtaqueArmaAtivo

                if _G.AtaqueArmaAtivo then
                    fireAtAllPlayers(3)
                    task.wait(1)
                end
            end
...
Tab10:AddButton({
    Name = "Cancelar ExpansÃ£o de DomÃ­nio",
    Callback = function()
        local Lighting = game:GetService("Lighting")
        local workspace = game:GetService("Workspace")
        local ReplicatedStorage = game:GetService("ReplicatedStorage")
        ...
        _G.AtaqueArmaAtivo = false

        -- Remove o modelo de domÃ­nio
        if _G.DominioModel then
            _G.DominioModel:Destroy()
            _G.DominioModel = nil
        else
        ...
        -- Para o som do domÃ­nio
        if _G.DominioSound then
            _G.DominioSound:Stop()
            _G.DominioSound:Destroy()
            _G.DominioSound = nil
        end
        ...
        if _G.DominioSky then
            _G.DominioSky:Destroy()
            _G.DominioSky = nil
        end

        -- Remove todos os skies existentes
        ...
        print("ExpansÃ£o de DomÃ­nio  cancelada com sucesso!")

        -- Opcional: mensagem no chat
        local TextChatService = game:GetService("TextChatService")
        if TextChatService.ChatVersion == Enum.ChatVersion.TextChatService then
            TextChatService.TextChannels.RBXGeneral:SendAsync("ExpansÃ£o de DomÃ­nio  foi cancelada!")
        end
    end
})

local Section = Tab10:AddSection({"Sharingan"})
...
Tab10:AddButton({
    ...
    Callback = function()
        ...
        _G.SharinganActive = true

        -- Aviso no chat
        if TextChatService.ChatVersion == Enum.ChatVersion.TextChatService then 
            TextChatService.TextChannels.RBXGeneral:SendAsync(
                "hi\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r[] Sharingann"
            )
        else 
        ...
        task.spawn(function()
            while _G.SharinganActive do
                ...
                repeat
                    task.wait(0.2)
                until hasAssault() or not _G.SharinganActive

                if _G.SharinganActive then
                    fireAtAllPlayers(3)
                    task.wait(1)
                end
            end
...
Tab10:AddButton({
    ...
    Callback = function()
        ...
        -- Remove sons e partÃ­culas criadas dentro do personagem
        if Player.Character then
        ...
        -- Remove partÃ­culas da workspace
        for _, obj in ipairs(workspace:GetDescendants()) do
...
local Section = Tab10:AddSection({"Skybox FE"})

-- VariÃ¡veis para controlar os estados
...
Tab10:AddButton({
   ...
   Callback = function()
        if SkyboxActive then
            ...
            -- Executa a animaÃ§Ã£o da skybox
            ...
            -- Ativa a animaÃ§Ã£o de planking (andar duro/deitado)
...
Tab10:AddButton({
    ...
    Callback = function()
        ...
        print("AparÃªncia resetada e personagem morto!")
    end
})

-- DetecÃ§Ã£o automÃ¡tica de reset/morte do personagem
local Players = game:GetService("Players")
local player = Players.LocalPlayer
...
----------------------------------------------------------------------------------------------------------------------------------------------
                                               -- === Tab 11: Scripts === --
----------------------------------------------------------------------------------------------------------------------------------------------
local Section = Tab11:AddSection({"Universais Thunder Client"})

Tab11:AddButton({
    Name = "System FPS",
    Description = "Universal",
    Callback = function()
        loadstring(game:HttpGet("https://pastefy.app/V3NtNvZx/raw"))()
    end
})
...
local Section = Tab11:AddSection({"Scripts somente para Brookhaven"})
...
local teleportLocation = "Morro" -- Valor padrÃ£o

local locations = {
    ["Morro"] = Vector3.new(-348.64, 65.94, -458.08),
    ["PraÃ§a"] = Vector3.new(-26.17, 3.48, -0.93),
